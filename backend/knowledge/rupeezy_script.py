...
OPENING_SCRIPTS = {
    "hindi": [
        "Namaste {name} ji! Main Ana, Rupeezy se. Kya aap broker ya financial advisor hain?",
        "Namaste! Ana bol rahi hoon Rupeezy se. {name} ji, aap investment field mein kaam karte hain?",
        "Namaskar {name} ji! Rupeezy ki Ana bol rahi hoon. Kya aap clients ko invest karate hain?",
    ],
    "english": [
        "Hi {name}! Ana here from Rupeezy. Are you a financial advisor or broker?",
        "Hello {name}! This is Ana calling from Rupeezy. Do you work with investment clients?",
        "Hi! Ana from Rupeezy. {name}, are you currently working as a financial advisor?",
    ],
    "hinglish": [
        "Hi {name}! Main Ana, Rupeezy se. Kya aap financial advisor ya broker hain?",
        "Hello {name} ji! Ana here from Rupeezy. Aap clients ke liye invest karte hain kya?",
        "Hi! Ana bol rahi hoon Rupeezy se. {name} ji, aap finance field mein hain?",
    ],
    "tamil": [
        "Vanakkam {name}! Naan Ana, Rupeezy-yil irundhu. Neengal financial advisor-aa?",
        "Vanakkam! Ana pesugiren Rupeezy-yil irundhu. {name}, neengal clients-ku invest pannuveergalaa?",
        "Vanakkam {name}! Rupeezy-yil irundhu Ana. Neengal broker-aa illai advisor-aa?",
    ],
    "telugu": [
        "Namaskaram {name}! Nenu Ana, Rupeezy nunchi. Meeru financial advisor-aa?",
        "Namaskaram! Ana ni, Rupeezy nunchi matladadam. {name} garu, meeru clients ki invest chestaaraa?",
        "Hello {name} garu! Rupeezy nunchi Ana. Meeru broker leda advisor-aa?",
    ],
    "kannada": [
        "Namaskara {name}! Naanu Ana, Rupeezy-inda. Neevu financial advisor-aa?",
        "Namaskara! Ana matnaduttiddene Rupeezy-inda. {name}, neevu clients-ge invest maadutteeraa?",
        "Hello {name}! Rupeezy-inda Ana. Neevu broker-aa athava advisor-aa?",
    ],
    "malayalam": [
        "Namaskaram {name}! Ente peru Ana, Rupeezy-il ninnum. Ningal financial advisor-aa?",
        "Namaskaram! Ana aanu, Rupeezy-il ninnum vilikkunnu. {name}, ningal clients-nu invest cheyyunnundo?",
        "Hello {name}! Rupeezy-il ninnum Ana. Ningal broker-aa athava advisor-aa?",
    ],
    "bengali": [
        "Namaskar {name}! Ami Ana, Rupeezy theke. Apni ki financial advisor?",
        "Namaskar! Ana bolchi, Rupeezy theke. {name}, apni ki clients-der jonno invest koren?",
        "Hello {name}! Rupeezy-r Ana bolchi. Apni ki broker na advisor?",
    ],
    "marathi": [
        "Namaskar {name}! Mi Ana, Rupeezy kaDun. Tumhi financial advisor aahaat ka?",
        "Namaskar! Ana bolat aahe Rupeezy kaDun. {name}, tumhi clients saathi invest karta ka?",
        "Hello {name}! Rupeezy chi Ana. Tumhi broker ki advisor?",
    ],
    "gujarati": [
        "Kem cho {name}! Hoon Ana, Rupeezy tharathi. Tame financial advisor cho?",
        "Kem cho! Ana bolav chu Rupeezy tharathi. {name}, tame clients mate invest karo cho?",
        "Hello {name}! Rupeezy ni Ana. Tame broker ke advisor cho?",
    ],
    "urdu": [
        "Assalamu Alaikum {name}! Main Ana, Rupeezy se. Kya aap financial advisor hain?",
        "Salam! Ana bol rahi hoon Rupeezy se. {name} sahab, aap clients ke liye invest karte hain?",
        "Hello {name}! Rupeezy ki Ana. Kya aap broker ya advisor hain?",
    ],
    "punjabi": [
        "Sat Sri Akal {name} ji! Main Ana, Rupeezy ton. Tusi financial advisor ho?",
        "Sat Sri Akal! Ana bol rahi haan Rupeezy ton. {name} ji, tusi clients layi invest karde ho?",
        "Hello {name} ji! Rupeezy di Ana. Tusi broker ho ya advisor?",
    ],
}
